...
public class FahrenheitCelsiusTest extends junit.framework.TestCase {
    ...
    //Lorsque la température F est < 31, la température C doit être négative
    public void test_sign()
    {
        assertTrue(question1.FahrenheitCelsius.fahrenheitEnCelsius(31) <0);
        assertTrue(question1.FahrenheitCelsius.fahrenheitEnCelsius(20) <0);
        assertTrue(question1.FahrenheitCelsius.fahrenheitEnCelsius(45) >0);
        assertTrue(question1.FahrenheitCelsius.fahrenheitEnCelsius(32) ==0);
    }
